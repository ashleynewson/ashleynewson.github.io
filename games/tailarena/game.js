...
Particle.prototype.render = function() {
    ...
    ctx.strokeStyle = this.overStrokeStyle ? this.overStrokeStyle : this.strokeStyle;
    ctx.stroke();
}
...
var main_loop = function() {
    if (action_will_restart && (mouse_click || analog.click)) {
        reset();
    }
